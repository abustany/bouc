...
pub struct Strings {
    ...
    pub index_hint_start_day: &'static str,
    pub index_hint_start_day_touch: &'static str,
...
static FR: Strings = Strings {
    ...
    index_hint_start_day: "Cliquer sur le premier jour du séjour",
    index_hint_start_day_touch: "Toucher le premier jour du séjour",
...
static EN: Strings = Strings {
    ...
    index_hint_start_day: "Click the first day of your stay",
    index_hint_start_day_touch: "Tap the first day of your stay",
